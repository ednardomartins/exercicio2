...
public class GeradorObservacaoTest {
	...
	public void geraObservacaoVaziaQuandoNaoExistemNotas() {
		String observacaoGerada = this.geradorObservacao.gerarObservacaoNotasFiscais(Collections.EMPTY_LIST);		
		assertTrue(observacaoGerada.isEmpty());
	}
	
	@Test
	public void geraObservacaoParaUmaNota() {
		String observacaoGerada = this.geradorObservacao.gerarObservacaoNotasFiscais(Arrays.asList(1));
	...
	public void geraObservacaoParaDuasNotas() {
		String observacaoGerada = this.geradorObservacao.gerarObservacaoNotasFiscais(Arrays.asList(1, 2));
	...
	public void geraObservacaoParaMultiplasNotas() {
		String observacaoGerada = this.geradorObservacao.gerarObservacaoNotasFiscais(Arrays.asList(1, 2, 3, 4, 5));
